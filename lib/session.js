...
var secureToken = function secureToken(token) {
  var salt = token.salt,
      ...
      finalToken = _objectWithoutProperties(token, ["salt", "derived_key"]);
...
var Session = function Session(config) {
  ...
  return {
    confirmToken: function () {
      ...
      return function confirmToken(_x, _x2) {
    ...
    deleteTokens: function () {
      ...
      return function deleteTokens(_x3) {
    ...
    fetchToken: function () {
      ...
      return function fetchToken(_x4) {
    ...
    storeToken: function () {
      ...
      return function storeToken(_x5) {
