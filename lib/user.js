...
var user = function user(config, userDB, couchAuthDB, mailer, emitter) {
  ...
  /*#__PURE__*/
  function () {
    var _ref2 = _asyncToGenerator(function* (userDoc, op, currentSession) {
      try {
        // When op is 'other' it will logout all sessions except for the specified 'currentSession'
        var sessions = [];

        if (op === 'all' || op === 'other') {
          sessions = _util.default.getSessions(userDoc);
        } else if (op === 'expired') {
          sessions = _util.default.getExpiredSessions(userDoc, Date.now());
        }
        ...
        if (sessions.length) {
          ...
          dbAuth.removeKeys(sessions); // Deauthorize keys from each personal database
  ...
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(function* (user_id, newPassword, userDoc, req) {
      req = req || {};
      var changePwUser;
      var doc = userDoc;
  ...
  /*#__PURE__*/
  function () {
    var _ref4 = _asyncToGenerator(function* (session_id) {
      var logoutUserDoc;
      var finalUser;
  ...
  /*#__PURE__*/
  function () {
    var _ref5 = _asyncToGenerator(function* (newUser) {
      // Add personal DBs
      ...
      /*#__PURE__*/
      function () {
        var _ref6 = _asyncToGenerator(function* (dbList, type) {
          return Promise.all(dbList.map(
          /*#__PURE__*/
          function () {
            var _ref7 = _asyncToGenerator(function* (userDBName) {
  ...
  /*#__PURE__*/
  function () {
    var _ref8 = _asyncToGenerator(function* (username, roles) {
      try {
        var _key;
  ...
  /*#__PURE__*/
  function () {
    var _ref9 = _asyncToGenerator(function* (base) {
      ...
      results.rows.forEach(function (_ref10) {
        var id = _ref10.id;
  ...
  /*#__PURE__*/
  function () {
    var _ref13 = _asyncToGenerator(function* (email) {
      if (!email) {
        return Promise.resolve();
      }
  ...
  passwordConstraints = Object.assign({}, passwordConstraints, config.getItem('local.passwordConstraints'));
  var userModel = {
    async: true,
  ...
  /*#__PURE__*/
  function () {
    var _ref14 = _asyncToGenerator(function* (fnArray, userDoc, provider) {
      var finalDoc = userDoc;
      yield Promise.all(fnArray.map(
      /*#__PURE__*/
      function () {
        var _ref15 = _asyncToGenerator(function* (fn) {
  ...
  /*#__PURE__*/
  function () {
    var _ref16 = _asyncToGenerator(function* (login) {
      var query;
  ...
  /*#__PURE__*/
  function () {
    var _ref17 = _asyncToGenerator(function* (form, req) {
      req = req || {};
      ...
      function () {
        var _ref18 = _asyncToGenerator(function* (result) {
          ...
          return _util.default.hashPassword(newUser.password);
        });
      ...
      /*#__PURE__*/
      function () {
        var _ref19 = _asyncToGenerator(function* (err) {
          return Promise.reject({
      ...
      /*#__PURE__*/
      function () {
        var _ref20 = _asyncToGenerator(function* (hash) {
          // Store password hash
          newUser.local = {};
      ...
      /*#__PURE__*/
      function () {
        var _ref21 = _asyncToGenerator(function* (nU) {
          return logActivity(nU._id, 'signup', 'local', req, nU);
        });
      ...
      /*#__PURE__*/
      function () {
        var _ref22 = _asyncToGenerator(function* (nU) {
          return processTransformations(onCreateActions, nU, 'local');
        });
      ...
      /*#__PURE__*/
      function () {
        var _ref23 = _asyncToGenerator(function* (finalNewUser) {
          return userDB.upsert(finalNewUser._id, function (oldUser) {
            return (0, _lodash.default)({}, oldUser, finalNewUser);
          });
        });
  ...
  /*#__PURE__*/
  function () {
    var _ref26 = _asyncToGenerator(function* (provider, auth, profile, req) {
      var userDoc;
      ...
      var _req = req,
          ip = _req.ip;
      yield _bluebird.default.resolve();
      ...
      try {
        ...
        if (results.rows.length > 0) {
          ...
          newAccount = true; // tslint:disable-next-line:no-object-literal-type-assertion
          ...
          console.log('generating username'); // Now we need to generate a username
        ...
        yield logActivity(userDoc._id, action, provider, req, userDoc);
    ...
    return function socialAuth(_x39, _x40, _x41, _x42) {
  ...
  /*#__PURE__*/
  function () {
    var _ref28 = _asyncToGenerator(function* (user_id, provider, auth, profile, req) {
      req = req || {};
      var linkUser;
      var results = yield userDB.query("auth/" + provider, {
        key: profile.id
    ...
    return function linkSocial(_x43, _x44, _x45, _x46, _x47) {
  ...
  /*#__PURE__*/
  function () {
    var _ref29 = _asyncToGenerator(function* (user_id, provider) {
      var unLinkUser;
      var theUser = yield userDB.get(user_id);
      unLinkUser = theUser;
      ...
      if (!unLinkUser.providers || !(unLinkUser.providers instanceof Array) || unLinkUser.providers.length < 2) {
        return Promise.reject({
          error: 'Unlink failed',
      ...
      return userDB.upsert(unLinkUser._id, function (oldUser) {
        var deleted = oldUser[provider],
            newUser = _objectWithoutProperties(oldUser, [provider]);
    ...
    return function unlink(_x48, _x49) {
  ...
  /*#__PURE__*/
  function () {
    var _ref30 = _asyncToGenerator(function* (user_id, provider, req) {
      ...
      dbAuth.storeKey(user_id, newToken.key, password, newToken.expires, createSessionUser.roles); // authorize the new session across all dbs
      ...
      yield userDB.upsert(finalUser._id, function (oldDoc) {
        if (oldDoc.local) {
      ...
      if (typeof createSessionUser.personalDBs === 'object') {
        ...
        if (config.getItem('dbServer.publicURL')) {
          var dbObj = _url.default.parse(config.getItem('dbServer.publicURL'));

          dbObj.auth = newSession.token + ":" + newSession.password;
          publicURL = dbObj.href;
        } else {
    ...
    return function createSession(_x50, _x51, _x52) {
  ...
  /*#__PURE__*/
  function () {
    var _ref31 = _asyncToGenerator(function* (loginUser, req) {
      req = req || {};
    ...
    return function handleFailedLogin(_x53, _x54) {
  ...
  /*#__PURE__*/
  function () {
    var _ref32 = _asyncToGenerator(function* (key) {
      var newSession;
      var oldToken = yield session.fetchToken(key);
      newSession = oldToken;
      newSession.expires = Date.now() + sessionLife * 1000;
      var results = yield Promise.all([userDB.get(newSession._id), session.storeToken(newSession)]);
    ...
    return function refreshSession(_x55) {
  ...
  var resetPassword = function resetPassword(form, req) {
    ...
    /*#__PURE__*/
    function () {
      var _ref34 = _asyncToGenerator(function* (err) {
        return Promise.reject({
          error: 'Validation failed',
          validationErrors: err,
          status: 400
    ...
    /*#__PURE__*/
    function () {
      var _ref35 = _asyncToGenerator(function* (results) {
        if (!results.rows.length) {
          return Promise.reject({
            status: 400,
            error: 'Invalid token'
    ...
    /*#__PURE__*/
    function () {
      var _ref36 = _asyncToGenerator(function* (hash) {
        if (!resetUser.local) {
          resetUser.local = {};
        }
    ...
    /*#__PURE__*/
    function () {
      var _ref37 = _asyncToGenerator(function* (userDoc) {
        resetUser = userDoc;
    ...
    /*#__PURE__*/
    function () {
      var _ref38 = _asyncToGenerator(function* (finalUser) {
        return userDB.upsert(finalUser._id, function (oldUser) {
  ...
  /*#__PURE__*/
  function () {
    var _ref40 = _asyncToGenerator(function* (user_id, form, req) {
      req = req || {};
      ...
      /*#__PURE__*/
      function () {
        var _ref42 = _asyncToGenerator(function* (err) {
          return Promise.reject({
            error: 'Validation failed',
            validationErrors: err,
            status: 400
      ...
      /*#__PURE__*/
      function () {
        var _ref44 = _asyncToGenerator(function* (userDoc) {
      ...
      /*#__PURE__*/
      function () {
        var _ref46 = _asyncToGenerator(function* (err) {
    ...
    return function changePasswordSecure(_x61, _x62, _x63) {
  ...
  /*#__PURE__*/
  function () {
    var _ref48 = _asyncToGenerator(function* (email, req) {
      req = req || {};
      var forgotPwUser;
      var token;
      var tokenHash;
    ...
    return function forgotPassword(_x67, _x68) {
  ...
  /*#__PURE__*/
  function () {
    var _ref49 = _asyncToGenerator(function* (token, req) {
      req = req || {};
      var verifyEmailUser;
    ...
    return function verifyEmail(_x69, _x70) {
  ...
  /*#__PURE__*/
  function () {
    var _ref50 = _asyncToGenerator(function* (user_id, newEmail, req) {
      req = req || {};
    ...
    return function changeEmail(_x71, _x72, _x73) {
  ...
  /*#__PURE__*/
  function () {
    var _ref51 = _asyncToGenerator(function* (user_id, dbName, type, designDocs, permissions) {
      var userDoc;
      ...
      var result = yield userDB.get(user_id);
      userDoc = result;
    ...
    return function addUserDB(_x74, _x75, _x76, _x77, _x78) {
  ...
  /*#__PURE__*/
  function () {
    var _ref52 = _asyncToGenerator(function* (user_id, dbName, deletePrivate, deleteShared) {
      var removeUser;
      var update = false;
      var dbID;
      var userDoc = yield userDB.get(user_id);
      ...
      if (removeUser.personalDBs && typeof removeUser.personalDBs === 'object') {
        ...
        /*#__PURE__*/
        function () {
          var _ref53 = _asyncToGenerator(function* (db) {
      ...
      if (update) {
        ...
        return userDB.upsert(removeUser._id, function (oldUser) {
    ...
    return function removeUserDB(_x79, _x80, _x81, _x82) {
  ...
  /*#__PURE__*/
  function () {
    var _ref54 = _asyncToGenerator(function* (user_id, session_id) {
      var logoutUserDoc;
      ...
      return userDB.upsert(logoutUserDoc._id, function (oldUser) {
        return (0, _lodash.default)({}, oldUser, logoutUserDoc);
      });
    });

    return function logoutUser(_x84, _x85) {
  ...
  /*#__PURE__*/
  function () {
    var _ref55 = _asyncToGenerator(function* (session_id) {
      var logoutUserDoc;
      var startSessions = 0;
      var endSessions = 0;
      var results = yield userDB.query('auth/session', {
      ...
      yield session.deleteTokens(session_id);
      dbAuth.removeKeys(session_id);

      if (logoutUserDoc) {
        yield dbAuth.deauthorizeUser(logoutUserDoc, session_id);
      }
    ...
    return function logoutSession(_x86) {
  ...
  /*#__PURE__*/
  function () {
    var _ref56 = _asyncToGenerator(function* (user_id, destroyDBs) {
      var removeUser;
      ...
      try {
        ...
        /*#__PURE__*/
        function () {
          var _ref57 = _asyncToGenerator(function* (userdb) {
    ...
    return function remove(_x87, _x88) {
      return _ref56.apply(this, arguments);
    };
  }();

  var removeExpiredKeys = dbAuth.removeExpiredKeys.bind(dbAuth);

  var confirmSession =
  /*#__PURE__*/
  function () {
    var _ref58 = _asyncToGenerator(function* (key, password) {
      return session.confirmToken(key, password);
    });

    return function confirmSession(_x90, _x91) {
