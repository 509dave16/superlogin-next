...
module.exports = function (config, userDB, couchAuthDB, mailer, emitter) {
  ...
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(function* (provider, auth, profile, req) {
      var user;
  ...
  /*#__PURE__*/
  function () {
    var _ref5 = _asyncToGenerator(function* (userDoc, op, currentSession) {
      try {
  ...
  /*#__PURE__*/
  function () {
    var _ref6 = _asyncToGenerator(function* (user_id, destroyDBs) {
      var user;
      var promises = [];
