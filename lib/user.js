...
var user = function user(config, userDB, couchAuthDB, mailer, emitter) {
  ...
  function () {
    var _ref4 = _asyncToGenerator(function* (session_id) {
      ...
      try {
        ...
        if (finalUser) {
          return yield userDB.upsert(finalUser._id, function (oldUser) {
  ...
  function () {
    var _ref17 = _asyncToGenerator(function* (form, req) {
      ...
      try {
        ...
        if (config.getItem('local.sendConfirmEmail')) {
          yield mailer.sendEmail('confirmEmail', newUser.unverifiedEmail.email, {
            req: req,
            user: newUser
          });
        }
  ...
  /*#__PURE__*/
  function () {
    var _ref18 = _asyncToGenerator(function* (provider, auth, profile, req) {
      var userDoc;
  ...
  /*#__PURE__*/
  function () {
    var _ref20 = _asyncToGenerator(function* (user_id, provider, auth, profile, req) {
      var _extends2;
  ...
  /*#__PURE__*/
  function () {
    var _ref21 = _asyncToGenerator(function* (user_id, provider) {
  ...
  /*#__PURE__*/
  function () {
    var _ref22 = _asyncToGenerator(function* (user_id, provider, req) {
      ...
      try {
        ...
        yield dbAuth.storeKey(user_id, newToken.key, password, newToken.expires, createSessionUser.roles); // authorize the new session across all dbs
  ...
  /*#__PURE__*/
  function () {
    var _ref23 = _asyncToGenerator(function* (loginUser, req) {
      req = req || {};
  ...
  /*#__PURE__*/
  function () {
    var _ref24 = _asyncToGenerator(function* (key, pass) {
      var newSession;
  ...
  var resetPassword = function resetPassword(form, req) {
    ...
    /*#__PURE__*/
    function () {
      var _ref26 = _asyncToGenerator(function* (err) {
        return Promise.reject({
          error: 'Validation failed',
    ...
    /*#__PURE__*/
    function () {
      var _ref27 = _asyncToGenerator(function* (results) {
        if (!results.rows.length) {
          return Promise.reject({
            status: 400,
            error: 'Invalid token'
    ...
    /*#__PURE__*/
    function () {
      var _ref28 = _asyncToGenerator(function* (hash) {
        if (!resetUser.local) {
          resetUser.local = {};
        }
    ...
    /*#__PURE__*/
    function () {
      var _ref29 = _asyncToGenerator(function* (userDoc) {
        resetUser = userDoc;
    ...
    /*#__PURE__*/
    function () {
      var _ref30 = _asyncToGenerator(function* (finalUser) {
  ...
  /*#__PURE__*/
  function () {
    var _ref32 = _asyncToGenerator(function* (user_id, form, req) {
      req = req || {};
      ...
      /*#__PURE__*/
      function () {
        var _ref36 = _asyncToGenerator(function* (userDoc) {
      ...
      /*#__PURE__*/
      function () {
        var _ref38 = _asyncToGenerator(function* (err) {
  ...
  /*#__PURE__*/
  function () {
    var _ref40 = _asyncToGenerator(function* (email, req) {
      req = req || {};
      var forgotPwUser;
      var token;
      var tokenHash;
  ...
  /*#__PURE__*/
  function () {
    var _ref41 = _asyncToGenerator(function* (token, req) {
      req = req || {};
      var verifyEmailUser;
  ...
  /*#__PURE__*/
  function () {
    var _ref42 = _asyncToGenerator(function* (user_id, newEmail, req) {
      req = req || {};
      var changeEmailUser;
      ...
      try {
        ...
        if (config.getItem('local.sendConfirmEmail')) {
          ...
          yield mailer.sendEmail('confirmEmail', changeEmailUser.unverifiedEmail.email, {
            req: req,
  ...
  /*#__PURE__*/
  function () {
    var _ref43 = _asyncToGenerator(function* (user_id, dbName, type, designDocs, permissions) {
      var userDoc;
  ...
  /*#__PURE__*/
  function () {
    var _ref44 = _asyncToGenerator(function* (user_id, dbName, deletePrivate, deleteShared) {
      var removeUser;
      var update = false;
      var dbID;
      ...
      if (removeUser.personalDBs && typeof removeUser.personalDBs === 'object') {
        ...
        /*#__PURE__*/
        function () {
          var _ref45 = _asyncToGenerator(function* (db) {
  ...
  /*#__PURE__*/
  function () {
    var _ref46 = _asyncToGenerator(function* (user_id, session_id) {
      var logoutUserDoc;
  ...
  /*#__PURE__*/
  function () {
    var _ref47 = _asyncToGenerator(function* (session_id) {
      var logoutUserDoc;
      var startSessions = 0;
      var endSessions = 0;
  ...
  /*#__PURE__*/
  function () {
    var _ref48 = _asyncToGenerator(function* (user_id, destroyDBs) {
      var removeUser;
      ...
      try {
        ...
        /*#__PURE__*/
        function () {
          var _ref49 = _asyncToGenerator(function* (userdb) {
  ...
  /*#__PURE__*/
  function () {
    var _ref50 = _asyncToGenerator(function* (key, password) {
